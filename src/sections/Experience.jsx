const experiences = [
    
    {
        ...
        technologies: ["Wordpress", "ChatGpt", "Javascript"],
        current: false,   
    }, 
]
                    ...
                    <div className="space-y-12">
                        {experiences.map((exp, idx) => (
                            ...
                            >
                                ...
                                {exp.current && <span  className="abolute inset-0 rounded-full bg-primary animate-ping opacity-75"/>}
                                </div>
                                {/* content */} 
                                <div className={`pl-8 md:pl-0 ${idx % 2 === 0 ? "md:pd-16 md:text-right" : "md:col-start-2 md:pl-16" }`}>
